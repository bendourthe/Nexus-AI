...
The Unused report is framed **"suggest first"**: it surfaces candidates, never verdicts, because the usage scan is heuristic and false negatives are possible (a skill may have been invoked in a way the scanner cannot see). No section of the audit ever emits a destructive imperative. See the adoption plan [docs/versions/v1/v1.3.0/plans/adoption-skill-cleaner.md](docs/archive/v1/v1.3/plans/adoption-skill-cleaner.md), its source comparison [docs/versions/v1/v1.3.0/comparison-skill-cleaner.md](docs/archive/v1/v1.3/comparison-skill-cleaner.md), and the runtime benchmark [docs/versions/v1/v1.3.0/benchmarks/skills-audit-2026-05-28.md](docs/archive/v1/v1.3/benchmarks/skills-audit-2026-05-28.md).

### Feature inventory contract (v2.4.9 Phase 3)
