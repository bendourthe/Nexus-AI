...
| MT-v251-1 | MT | v2.5.1 Phase 1 | `docs/v2/v2.5/plans/v2.5.1-adoption-packaged-verification-and-accessibility.md` | 21 `jsx-a11y` warnings remain after the image viewer backdrop became a button. The lint ceiling is 21. | Fix the remaining click and focus warnings. Do not raise `--max-warnings` to hide new ones. |
