...
| QG-v251-3 | QG | v2.5.1 Phase 4 | `docs/v2/v2.5/plans/v2.5.1-adoption-packaged-verification-and-accessibility.md` | The Tier 3 deep pass stopped as a bounded result. Rendered-surface delegates, the adversarial verifier, and implementation-convergence were not run. | Run those three checks against the plan artifacts and attach their output under `## Tier 3 deep pass`. |
