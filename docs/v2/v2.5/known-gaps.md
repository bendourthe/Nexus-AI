...
| MT-v251-1 | MT | v2.5.1 Phase 1 | `docs/v2/v2.5/plans/v2.5.1-adoption-packaged-verification-and-accessibility.md` | 43 `jsx-a11y` warnings remain after labels that wrap `TextField`, `Select`, and `SearchInput` were recognized as associated controls. The lint ceiling is 43. | Fix the remaining click, media, and focus warnings. Do not raise `--max-warnings` to hide new ones. |
