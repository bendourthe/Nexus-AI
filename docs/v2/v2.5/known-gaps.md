...
| MT-v251-1 | MT | v2.5.1 Phase 1 | `docs/v2/v2.5/plans/v2.5.1-adoption-packaged-verification-and-accessibility.md` | 31 `jsx-a11y` warnings remain after label association, caption tracks, menu checkbox roles, and the message lightbox controls. The lint ceiling is 31. | Fix the remaining click and focus warnings. Do not raise `--max-warnings` to hide new ones. |
