...
| MT-v251-1 | MT | v2.5.1 Phase 1 | `docs/v2/v2.5/plans/v2.5.1-adoption-packaged-verification-and-accessibility.md` | 54 existing `jsx-a11y` warnings across `desktop/src`, `sidecar/src`, and `tests` were measured and left unfixed. The lint ceiling is 54. | Fix the warnings in a later pass. Do not raise `--max-warnings` to hide new ones. |
