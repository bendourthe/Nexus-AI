...
- **DF-v240-2** - TripoSplat file SHA-256 pins are not in the catalog. Source phase: 5. Plan reference: T014. Reason: `source.sha256` is the all-zero placeholder the digest test requires, and `source.revision` is the Hugging Face commit observed on 2026-09-23. The weight files themselves were not hashed. Suggested next step: pin `diffusion_models/triposplat_fp16.safetensors` and the sibling files with `scripts/installer/build/pin-hf-weights.py` after a successful fetch.
...
- **NI-1 (resolved)** - `minicpm5:2b` uses `toolFormat: "none"`. The `none` parser returns no calls, so the chat-only row does not claim the qwen envelope. Resolved 2026-09-21.

- **NI-2 (resolved)** - Per-id catalog checks dispatch through `_ID_CONTRACTS`. `^def _check_.*_entry` is gone. Resolved 2026-09-21.

- **NI-3 (resolved)** - `MODEL_FAMILIES` is the single family tuple. The sidecar Zod enum and the enumeration tests derive from it. Resolved 2026-09-21.
...
- **Plan reference**: `docs/archive/v2/v2.4/plans/v2.4.6-field-delivery-density-and-session-identity.md` (sub-tasks 2.1-2.3)
...
- **Plan reference**: `docs/archive/v2/v2.4/plans/v2.4.6-field-delivery-density-and-session-identity.md` (sub-tasks 3.1-3.4)
...
- **Plan reference**: `docs/archive/v2/v2.4/plans/v2.4.6-field-delivery-density-and-session-identity.md` (sub-tasks 4.1-4.4)
...
- **Plan reference**: `docs/archive/v2/v2.4/plans/v2.4.6-field-delivery-density-and-session-identity.md` (sub-tasks 5.1-5.4)
...
- **Plan reference**: `docs/archive/v2/v2.4/plans/v2.4.6-field-delivery-density-and-session-identity.md` (sub-tasks 6.1-6.2)
...
- **Plan reference**: `docs/archive/v2/v2.4/plans/v2.4.6-field-delivery-density-and-session-identity.md` (sub-tasks 7.1-7.4)
...
- **Source phase**: Phase 3 - Configuration, VS Code host, and Review groups
- **Plan reference**: `docs/archive/v2/v2.4/plans/v2.4.6-field-delivery-density-and-session-identity.md` (sub-task 3.2)
...
- `docs/archive/v2/v2.4/known-gaps.md` (this file): v2.4.3 MT-2, MT-3, MT-4, MT-6, and MT-7 are each superseded by a v2.4.4 row that states the same unobserved limit against the new code. None is closed: this cycle produced no packaged observation, and the plan forbids closing them because a fix exists. v2.4.3 MT-1 (installer two-column, Unsloth lock) and MT-5 (picker order) are carried forward untouched - this screenshot set does not cover them.
- `docs/archive/v2/v2.3/known-gaps.md`: still in-progress. Nothing observed here bears on MT-1 or the v2.3.0 DF/QG rows. Unchanged.
- `docs/archive/v2/v2.0/known-gaps.md`: still in-progress with hardware and audio deferrals. No observation this cycle. Unchanged.
- `docs/archive/v1/v1.20/known-gaps.md`, `docs/archive/v1/v1.19/known-gaps.md`: still in-progress. No v2.4.4 observation closes their DF rows. Unchanged.
- `docs/archive/v1/v1.3/known-gaps.md`, `docs/archive/v1/v1.5/known-gaps.md`, `docs/archive/v1/v1.8/known-gaps.md`: open or rehearsal-blocked historical carryforward. Unchanged.
- `docs/v2/v2.1`, `docs/v2/v2.2`, and the remaining `docs/archive/v1/**` and `docs/archive/**` ledgers: finalized. Left in place; no historical GPU or visual row was closed without new observation.

### Reconciliation of Earlier Active Files

- `docs/archive/v2/v2.3/known-gaps.md`: reviewed 2026-08-30; still in-progress. v2.4.1 generation recovery does not close MT-1 or the v2.3.0 DF/QG rows. They remain unchanged.
- `docs/archive/v2/v2.2/known-gaps.md`: finalized; packaged GPU evidence is still absent, so historical rows remain unchanged.
- `docs/archive/v2/v2.1/known-gaps.md`: finalized; no change.
- `docs/archive/v2/v2.0/known-gaps.md`: reviewed 2026-08-30; still in-progress with DF-1 and other hardware/audio deferrals. This cycle produced no observed evidence for those rows.
- `docs/archive/v1/v1.20/known-gaps.md` and `docs/archive/v1/v1.19/known-gaps.md`: still in-progress. No v2.4.1 observation closes their remaining DF rows.
- `docs/archive/v1/v1.8/known-gaps.md` and `docs/archive/v1/v1.5/known-gaps.md`: still in-progress or rehearsal-blocked; not modified.
- `docs/archive/v1/v1.3/known-gaps.md`: Status remains open for historical skill-cleaner carryforward; not modified.
