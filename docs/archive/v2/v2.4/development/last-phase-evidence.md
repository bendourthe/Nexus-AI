...
Glob `docs/**/known-gaps.md` returned 30 files, including `docs/archive/v2/v2.4/known-gaps.md` and the v1, v2.0-v2.3, and archive copies. No `docs/releases/**/known-gaps.md` file was found.
...
Pull request 68 merged to `develop` as `40382596` on 2026-09-23. Post-merge CI, Shell Build, CodeQL, and installer tests completed with conclusion `success` on that commit. This v2.4.11 release commit archives the v2.4 tree after that merge.
