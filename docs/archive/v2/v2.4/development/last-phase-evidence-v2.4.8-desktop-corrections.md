...
gh pr create --base develop --title "v2.4.8: desktop token split, persona chrome, Sessions title, models parity, picker order" --body-file docs/archive/v2/v2.4/development/last-phase-evidence-v2.4.8-desktop-corrections.md
```
